DROP DATABASE if EXISTS sh_testdb;
CREATE DATABASE sh_testdb;
USE sh_testdb;
...
ALTER TABLE tbl_skill ADD FOREIGN KEY (member_id) REFERENCES tbl_profile (profile_member_id);
...
-- 프로필 별 skill 삽입
INSERT INTO tbl_skill(skill_id, url, tag_id, member_id) VALUES
...
-- 회원 별 권한
INSERT INTO tbl_member_auth(member_id, auth_id) VALUES 
(1,1),(1,2),(1,3),(1,4),
(2,3),(2,4),
(3,1),(3,2),(3,3),(3,4),
(4,2),(4,1),(4,3),(4,4),
