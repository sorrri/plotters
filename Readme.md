...
| 이름   | 평가                                                                                                                                                                                                                                                                              |
|------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 본인소감 | 너무너무 고생 했다 우리팀 모두들...                                                                                                                                                                                                                                                           |
| 김소리  | 세세한 부분을 잘 찝어주십니다. 맞춰나가야 할 부분이 있거나 디테일하게 들어갈 부분을 잘 찾고 공유해주십니다. </br> </br> 본인 의견을 잘 말하시고 본인 의견과 다른 의견에 대해서도 같이 조율해 나갔던 점이 좋은 프로젝트가 나올 수 있는 이유였다는 생각이 들었습니다. </br> 덕분에 완성도 높은 산출물이 나올 수 있었습니다.                                                                                    |
| 용길한  | 명확한 합의점을 지정하여 프로젝트 진행 방향이 바뀌지 않도록 해주셔서 좋았습니다. </br> </br> 특히, 의견의 합치를 기록하여, 우리가 어떤 방향으로 나아가야하는지에 대한 근거를 지정해주셨기에, 성공적으로 프로젝트를 마무리지을 수 있었습니다.                                                                                                                                     |
| 장민근  | 프로젝트를 진행할 때 정말 꼼꼼히 봐야만 볼 수 있는 부분을 잘 짚어주셨습니다 이 부분은 프로젝트에 대한 이해도가 높아야만 캐치가 가능하다고 생각하는데, 돌이켜 보면 서현님은 사소한 부분이라도 헷갈리면 질문하고 피드백하는 과정을 무수히 반복하면서 프로젝트에 대한 이해도를 높이셨었습니다. </br>  </br> 제가 가장 본받아야할 자세를 가진 분이 아닐까 생각하게 되는 인상깊은 팀원분이셨습니다.                                                  |
| 정준서  | 산출물 작성에 있어 꼼꼼히 검수하고, 틀린 점을 찾아내는 집중력이 대단하다 생각했습니다. </br> </br> 프로젝트 전반적으로 논리적 오류와 지나치기 쉬운 작은 에러들에 대처해주셔서 완성도 높은 프로젝트 진행에 기여해주신 점 감사합니다. </br> </br> 또한, 처음 진행하는 팀 프로젝트인 만큼 방향을 잡지 못해 갈팡질팡 할 때가 많았는데 그럴 때마다 올바른 길과 효율적인 길을 찾으려 고민하시는 모습이 마치 저희 팀이라는 버스의 핸들을 잡고 있는 운전수 같아 감명받았습니다. |
...
| 이름   | 평가                                                                                                                                                                                                                                                                                               |
|------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 본인소감 | 첫 프로젝트를 진행해 보았는데 제가 많이 부족하다는 생각이 들었습니다. 전공자임에도 불구하고 프로젝트를 이해하는데 약간의 어려움을 느꼈습니다. 의견도 많이 못 낸 것 같고 이끌려만 간 것 같다는 생각이 들었습니다. 팀원분들 다 능력 있으십니다. 팀원분들을 본받으면서 이번 프로젝트를 기반으로 다음 프로젝트때부터는 더 적극적으로 참여하고 제 몫을 다 할 수 있는 사람이 되어야겠습니다..다들 수고하셨습니다!!                                                              |
| 김서현  | 문서정리(특히 스프레드 시트) 진짜 잘하십니다.                                                                                                                                                                                                                                                                       |
| 용길한  | 프로젝트의 산출물들을 잘 정리하여 문서화를 진행해주신 부분이 인상깊었습니다. </br> </br> 요구사항 명세서나 기능명세서 등 필요한 구색을 갖춰주셔서 내용을 바로 기입할 수 있었습니다.                                                                                                                                                                                       |
| 장민근  | 팀원 모두가 바쁨에도 불구하고 시간을 내어서 각종 문서화에 필요한 양식을 만들어주셨고 퀄리티 또한 훌륭했습니다. </br>   </br> 또한 프로젝트에 대해 날카로운 시선으로 한 번씩 내어주는 의견 또한 매번 반영이 될 만큼 훌륭한 실력을 보유하고 있습니다.                                                                                                                                                |
| 정준서  | 프로젝트 전반적인 산출물의 틀을 작성해주시고 정리해주셔 문서 관리가 쉬웠고, 어려운 일에도 포기하지 않고 끈기가 있으신 분입니다. </br> </br> 미리 작성해주신 산출물 작성 틀이 없었다면 마치 비포장 도로를 달리는 자동차처럼 프로젝트를 진행하며, 몇 번이고 덜컹거리고 브레이크를 밟게 되었겠지만 소리님께서 아스팔트를 깔아 매끄러운 프로젝트를 진행이 되었다 생각합니다. </br> </br> 또한, 뒤에서 쉬운 일이든 어려운 일이든 묵묵히 진행해주시고, 프로젝트에 이바지하신 점이 존경받아 마땅하다 생각합니다. |
...
| 이름   | 평가                                                                                                                                                                                                                                                                                                                                          |
|------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 본인소감 | ORM이 너무 잘 되어 쉽게 서버를 구축할 수 있는 환경에 놓여졌기에, SQL 쿼리에 대해 깊게 고찰할 수 있는 기회가 없었다. </br> </br> 또한, 구현 자체에 의미를 두었던 기존 프로젝트들과 대비하여, 데이터베이스의 효용성과 효율성을 고려하며 모델링을 진행했다는 점에서 개인적인 발전을 이뤘다고 본다. </br> </br> 이번 프로젝트를 통해 데이터베이스 구동 방식, 서비스 운영 측면에서의 데이터베이스 모델링, 데이터베이스 운영 전략을 명확하게 알고 넘어가 좋았다. </br> </br> 짧은 기간인데도 불구하고 열심히 노력하여 프로젝트를 완료한 동료들 너무 고생하셨습니다 ;) |
| 김서현  | 항상 열심히 하시는 모습이 좋았습니다.                                                                                                                                                                                                                                                                                                                       |
| 김소리  | 주제를 되게 잘 던져주십니다. 덕분에 주제선정에 큰 시간을 잡아먹지 않고 프로젝트를 진행할 수 있었던 것 같습니다. </br> 생각나는 문제점이나 추가적인 내용을 바로바로 얘기해주셔서 빠른 수정 및 추가가 가능했던 것 같습니다. </br> </br> 이러한 점 덕분에 크게 수정해야 하거나 처음부터 다시 해야하는 불상사가 일어나지 않은 것 같습니다. 프로젝트 진행함에 있어 사람들을 잘 이끌어가고 리더쉽이 있으신 분이라는 생각이 들었습니다.                                                                                      |
| 장민근  | 우리 프로젝트에 중심이 되어준 팀원이라고 말하고 싶습니다. 항상 먼저 나서서 의견을 제시해주었고 그 근거또한 명확하여 어떤 의도를 갖고 말하는지 이해가 수월했습니다. </br> </br> 또한 본인의 단점이 “대부분의 경우에 깊게 생각하는 것” 이라고 말씀 하셨었는데, 그 부분이 오히려 장점이 되어 짧았던 프로젝트임에도 결과물이 매우 훌륭할수 있지 않았나 하는 생각이 듭니다.           |
| 정준서  | 한 마디로 말씀드리자면 프로젝트의 아버지 같은 분이라 할 수 있습니다. 다양한 의견제시와 프로젝트를 이끌어 가는 힘이 남다른 분으로 팀원들이 주춤거릴 때, 원동력을 주셨습니다. </br> </br> 다양한 지식과 본인의 의견을 아낌없이 제시하여 자칫하면 밋밋하고, 그저그런 프로젝트가 될 수 있었던 것에 기름을 부어 활력을 불어넣었다고 생각합니다. </br> </br> 본인의 의견제시가 많은 만큼 프로젝트에 열정과 애정을 가지고  진행해주신 점에 존경스럽다는 말씀 드리고 싶습니다.                                                              |
...
| 이름   | 평가                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 본인소감 | 부트캠프에 입과하고 나서 첫 수업으로 데이터베이스를 단기간 배웠다. 처음에는 단순히 쿼리를 갖고 어떻게 활용해야할지 감이 잡히지 않은 상태에서 프로젝트에 돌입했는데 이 때 많은 어려움을 겼었다. 분명 학부시절 배우고 프로젝트 또한 진행했던 과목임에도 나에게는 왜 이렇게 낯설었는지.. </br> </br> 지금 돌이켜 생각해보면 한 주제에 대해 깊이있게 고민한 경험이 없었던 나에겐 당연한 결과일지도 모르겠다. </br> </br> 그러나 이번 프로젝트를 진행하면서 나에게 무엇이 부족하고 어떤 자세로 학습하여 프로젝트를 대해야 할지에 대해 깊이있게 생각해볼 수 있는 좋은 계기였다고 생각한다. </br> </br> 예비군으로 마지막 가장 바쁠 때 참여하지 못해 미안한 마음을 갖고 있고, 많은 고생을 한 팀원분들에게 감사하다는 말을 전해주고싶다. |
| 김서현  | 의견 정리를 잘하십니다.                                                                                                                                                                                                                                                                                                                                                                                                                      |
| 김소리  | 의견 정리를 잘해주십니다. 여러 의견들에서 합의점을 찾아 잘 도출해주십니다. </br> </br> 또한 살짝 벗어난 의견에 대해서도 방향성을 잘 잡아주십니다. </br> 예비군 훈련과 겹쳐 정신없으셨을텐데도 본인의 일에 대해 잘 해주시고 가셔서 믿을 수 있는 팀원이라는 생각이 들었습니다.                                                                                                                                                                                                                                                                  |
| 용길한  | 문제나 과업이 주어졌을 때, 합리적인 합의점을 도출하여 의견을 제시해주셨습니다. </br> </br> 특히, 프로젝트 기획단계에서 다양한 의견이 주어졌을 때, 각 의견의 장단점을 분석하여 합리적인 의사결정을 진행하는데에 큰 기여를 진행해주셨습니다.                                                                                                                                                                                                                                                                                         |
| 정준서  | 팀 프로젝트 간 의견조율과 정리를 잘해주시고, 깊이 있는 고민을 해주셔서 프로젝트 외적으로 생기는 어려움에 잘 대처해주셨다고 생각이 듭니다. </br> </br> 저희 팀은 다양한 의견이 나오고, 많은 커뮤니케이션이 나와 프로젝트가 난잡해져 방향성이 어긋날 때가 많았는데 그럴 때마다 주변의 의견을 깊이감 있게 고민하고, 의견을 조율해주셔서 어긋난 방향을 잡아주시는 마치 조수석 자리에 있으신 분입니다. </br> </br> 또한, 본인의 일도 묵묵히 잘해주셔서 항상 하시는 말씀에 신뢰를 느끼게 되어 프로젝트 진행하며 지지가 되는 팀원분이셨습니다.                                                                                                                |
...
| 이름   | 평가                                                                                                                                                                                                                                                                                                                        |
|------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 본인소감 | 첫 프로젝트의 소감은 "힘들었다. 그러나 도착했다" 로 정의할 수 있을 것 같다. </br> </br> 2주 정도의 수업을 듣고, 그것을 프로젝트에 바로 적용하는 것은 힘겨운 일이었다. 프로젝트의 기간도 넉넉하지 않았고, 습득한 지식을 내것으로 소화해 활용할 수 있는 역량 또한 부족했다.</br> </br> 이때, 팀원분들의 도움이 컸습니다. 알고 있던 지식들을 프로젝트에 적용하였지만 해결 하기 힘든 문제들도 많았고, 그럴 때마다 다양한 의견교환과 아이디어를 통해 혼자서는 이를 수 없는 목표에 다다른 것 같습니다. 팀원들에게 감사하다는 말씀 드리고 싶네요 |
| 김서현  | 팀이 나아갈 방향 제시를 잘 해주십니다.                                                                                                                                                                                                                                                                                                    |
| 김소리  | 개발자로서의 능력이 대단한 것 같습니다. </br> 머리속에서 바로바로 코드가 돌아가는 것이 얼마나 많은 경험을 통해야 그렇게 되는 것인지 정말 존경스럽습니다. </br> 어려운 부분에 있어서도 많은 도움을 주시고 재치도 있으셔서 같이 프로젝트 하는데 정말 좋은 팀원이라는 생각이 들었습니다.                                                                                                                                                       |
| 용길한  | 기본적으로 구현력이 뛰어나신 분입니다. </br> </br> 문제를 정의하고 해당 문제에 대한 해결점을 찾아 도출해내는 방식이 인상깊었습니다. </br> </br> 단순히 방식을 도출해내는 데에 그치지 않고, 문제 해결을 어떻게 진행하는지에 대한 예시를 제시해주셔서 합리적인 의사결정에 대한 근간을 만들 수 있었습니다. </br> </br> 특히, trigger만을 통해서 비즈니스 로직의 무결성을 지키기 어려운 시점에 transaction을 통해 무결성을 지켜내며 troubleshooting을 진행한 점이 인상깊었습니다.                     |
| 장민근  | 팔로워쉽과 리더쉽을 함께 보유한 팀원이라고 생각합니다. </br> </br> 팀원이 기술적 어려움을 겪고 있을 때 직접 나서서 해결해주기도 하며 길한님처럼 프로젝트를 리드하는 사람이 있는 경우에는 뒤에서 묵묵히 자기 몫을 다했습니다. </br> </br> 기술적으로 성장하고 싶은 저에게 있어 많은 배울점이 있는 팀원이라고 생각합니다.      |
